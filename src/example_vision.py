...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('vision_demo.log'),
...
def main() -> None:
    ...
    print(f"📁 Analyzing: paris_landmark.jpg")
    print(f"💬 Prompt: Describe this landmark and its historical significance")
    ...
    print(f"📁 Analyzing: document_screenshot.png")
    print(f"💬 Prompt: Extract key information and summarize this document")
    ...
    print(f"📁 Analyzing: product_photo.jpg")
    print(f"💬 User: What can you tell me about this product?")
    ...
    print(f"📁 Analyzing: chart_diagram.png")
    print(f"💬 Prompt: Extract data points and explain this chart")
    ...
    print(f"📁 Analyzing: paris_landmark.jpg")
    print(f"💬 Testing different detail levels...")
